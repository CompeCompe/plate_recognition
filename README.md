...
Для замера общей скорости в файл `detect_osr.py` добавили код для распознавания номера.


**Метрики общей скорости для Yolov7 (дополнительно был поставлен флаг --v5-metric):**
