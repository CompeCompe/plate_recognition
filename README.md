...
На основани полученных результатов была выбрана модель **Yolov5m**, так как ее скорость детекции немного быстрее, а вес модели значительно ниже, при сравнительно одинаковом качесте обнаружения.
